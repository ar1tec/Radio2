...
abstract class RemoteViewsAction extends Action<RemoteViewsAction.RemoteViewsTarget> {
    ...
    RemoteViewsAction(Angelo angelo, Request data, RemoteViews remoteViews, int viewId,
                      int errorResId, int memoryPolicy, int networkPolicy, Object tag, String key,
                      Callback callback) {
        super(angelo, null, data, memoryPolicy, networkPolicy, errorResId, null, key, tag, false);
    ...
    static class AppWidgetAction extends RemoteViewsAction {
        ...
        AppWidgetAction(Angelo angelo, Request data, RemoteViews remoteViews, int viewId,
