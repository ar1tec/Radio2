...
public class Proxy implements Runnable {
    ...
    private class MyClientConnection extends DefaultClientConnection {
        @Override
    ...
    private class MyClientConnectionOperator extends DefaultClientConnectionOperator {
        private MyClientConnectionOperator(final SchemeRegistry sr) {
            super(sr);
        }
    ...
    private class MyClientConnManager extends SingleClientConnManager {
