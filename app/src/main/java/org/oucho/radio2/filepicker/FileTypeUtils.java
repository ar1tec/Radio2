...
public class FileTypeUtils {
    public enum FileType {
        ...
        MUSIC(R.drawable.ic_music_box, R.string.type_music, "aiff", "aif", "wav", "flac", "m4a", "wma", "amr", "mp2", "mp3", "wma", "aac", "mid", "m3u", "ogg"),
        ...
        ARCHIVE(R.drawable.ic_zip_box, R.string.type_archive, "apk", "cab", "7z", "alz", "arj", "bzip2", "bz2", "dmg", "gzip", "gz", "jar", "lz", "lzip", "lzma", "zip", "rar", "tar", "tgz"),
        APK(R.drawable.ic_zip_box, R.string.type_apk, "apk");
